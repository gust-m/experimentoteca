export const kits = [
  ...
  },
  {
    ...
    video_url: '',
    ingredients:
      'Pote de vidro (assim é possível ver o processo de germinação completo), um grão de feijão, algodão',
    instructions: [
      '1. Umedeça o algodão com a água, encha o vidro com o algodão úmido, coloque o feijão no algodão na lateral do vidro.',
      '2. Aí é só cuidar da sementinha! Cuidado para não deixar o algodão ficar seco, colocando água aos pouquinhos, uma vez ao dia ou quando necessário.',
      '3. Em cerca de 3 dias, a raiz começa a aparecer no feijão. Quando o feijão crescer mais de 20cm, transfira ele para um pote com terra!',
    ],
    explanation:
      'A semente do  tem uma reserva de nutrientes (como ocorre em cerca de 90% das plantas). Como sua casca é permeável, a semente absorve o líquido, que, junto dos nutrientes, faz o feijão germinar em até três dias. Cerca de 24 horas depois disso, surge a primeira folha. A planta ainda consegue sobreviver por mais uma semana, até que a terra fica indispensável para que ela cresça.',
    subjects: ['biology'],
    subjectsPT: ['Biologia'],
  },
  {
    ...
    name: 'Encher balões',
    video_url: '',
    ingredients: 'Fermento biológico, garrafa, açúcar, água morna e bexiga.',
    instructions: [
